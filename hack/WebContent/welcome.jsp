...
<tr>
<td>
<u>Employees under You</u>
<%
PreparedStatement pst=conn.prepareStatement("select empname from hemp where mgrid=?");
pst.setString(1,session.getAttribute("empid").toString());
ResultSet rs=pst.executeQuery();
...
while(rs.next())
{
	...
	<h4><% out.println(rs.getString("empname"));%></h4>
<%	out.println("</br>");
...
<input type=submit value="New Employee Onboarding"><br><br>
</form>
<form action="report.jsp">
<input type="submit" value="View Ticket and Access Status"><br><br>

</form>
<form action="process.jsp">
<input type="submit" value="Request Process Tool">
